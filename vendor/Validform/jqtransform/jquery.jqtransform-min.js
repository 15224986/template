(function(d) {
    ...
    d.fn.jqTransSelect = function() {
        return this.each(function(o) {
            ...
            var p = b(j);
            var n = j.addClass("jqTransformHidden").wrap('<div class="jqTransformSelectWrapper"></div>').parent();
            ...
            console.log(j.parent().parent().outerWidth());
            var k = Math.floor(j.parent().parent().outerWidth());
            n.css("width", "100%");
